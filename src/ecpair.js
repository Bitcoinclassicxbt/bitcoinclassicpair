...
const bitcoinclassicjs_lib_1 = require('bitcoinclassicjs-lib');
...
function ECPairFactory(ecc) {
  ...
  function fromWIF(wifString) {
    ...
    const network = bitcoinclassicjs_lib_1.networks.bitcoinclassic;
  ...
  class ECPair {
    ...
    constructor(__D, __Q, options) {
      ...
      this.network = bitcoinclassicjs_lib_1.networks.bitcoinclassic;
      if (__Q !== undefined)
